...
const ROUND_EVENTS = [
  {
    title: "Kickoff",
    zhTitle: "项目启动",
    text: "The idea is greenlit — start building.",
    zhText: "想法获批——开始构建吧。",
  },
  {
    title: "First Build",
    zhTitle: "首次构建",
    text: "Your first features take shape.",
    zhText: "你的第一批功能开始成形。",
  },
  {
    title: "Early Users",
    zhTitle: "早期用户",
    text: "Early users start trying your product.",
    zhText: "早期用户开始试用你的产品。",
  },
  {
    title: "Growth Spurt",
    zhTitle: "增长期",
    text: "Word spreads and the product gains momentum.",
    zhText: "口碑扩散，产品势头渐起。",
  },
  {
    title: "Crunch Time",
    zhTitle: "冲刺阶段",
    text: "Heads down — ship as much as you can.",
    zhText: "埋头开发——尽可能多地交付。",
  },
  {
    title: "Polish",
    zhTitle: "打磨阶段",
    text: "Last refinements before the big reveal.",
    zhText: "大展示前的最后打磨。",
  },
  {
    title: "Demo Day",
    zhTitle: "演示日",
    text: "Show the room what you built.",
    zhText: "向全场展示你做出的东西。",
  },
];
